...
function(opendaq_complete_boost_dependency)
    ...
    if (Boost_FOUND)
        ...
        get_target_property(BOOST_HEADERS_ALIAS Boost::headers ALIASED_TARGET)
        if (BOOST_HEADERS_ALIAS)
            set(BOOST_HEADERS_TARGET ${BOOST_HEADERS_ALIAS})
        endif()

        foreach(BOOST_TARGET ${BOOST_INCLUDE_LIBRARIES})
            if (NOT TARGET Boost::${BOOST_TARGET} AND NOT TARGET boost_${BOOST_TARGET})
                add_library(Boost::${BOOST_TARGET} ALIAS ${BOOST_HEADERS_TARGET})
            endif()
        endforeach()
    endif()
endfunction()
