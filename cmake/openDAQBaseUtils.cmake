get_filename_component(OPENDAQ_BASE_UTILS_CMAKE_FILE_REALPATH "${CMAKE_CURRENT_LIST_FILE}" REALPATH)
if(DEFINED OPENDAQ_BASE_UTILS_INCLUDED_FROM_PATH)
    message(STATUS
        "Skipping re-include of ${CMAKE_CURRENT_LIST_FILE}\n"
        "  already included from:\n"
        "    ${OPENDAQ_BASE_UTILS_INCLUDED_FROM_PATH}\n"
        "  attempted from:\n"
        "    ${OPENDAQ_BASE_UTILS_CMAKE_FILE_REALPATH}"
    )
    return()
endif()
set(OPENDAQ_BASE_UTILS_INCLUDED_FROM_PATH "${OPENDAQ_BASE_UTILS_CMAKE_FILE_REALPATH}")

function(opendaq_print_var VARIABLE_NAME)
    message(STATUS "${VARIABLE_NAME}: ${${VARIABLE_NAME}}")
endfunction()

function(opendaq_get_current_folder OUTFOLDER)
...
function(opendaq_generate_version_header LIB_NAME)
...
function(opendaq_check_if_files_exist DIR INPUT_FILES)
...
macro(opendaq_add_application_option OPTION_VAR DESCRIPTION DEFAULT_VALUE)
...
function(opendaq_dump_cmake_variables)
...
macro(opendaq_is_git_repository_root DIRECTORY_PATH FUNC_RESULT)
...
function(opendaq_add_cmake_targets DIR INOUT_TARGET_LIST)
...
endfunction(opendaq_add_cmake_targets)
