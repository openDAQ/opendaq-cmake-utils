...
macro(opendaq_setup_cmake_policies)
    # CMP0074:
...
endmacro(opendaq_setup_cmake_policies)

macro(opendaq_setup_repo_gnu_and_clang_common_flags REPO_OPTION_PREFIX)
    if (UNIX)
...
macro(opendaq_setup_repo_gnu_compiler_flags REPO_OPTION_PREFIX)
    opendaq_setup_repo_gnu_and_clang_common_flags(${REPO_OPTION_PREFIX})
...
macro(opendaq_setup_repo_msvc_compiler_flags REPO_OPTION_PREFIX)
...
macro(opendaq_setup_repo_clang_compiler_flags REPO_OPTION_PREFIX)
    opendaq_setup_repo_gnu_and_clang_common_flags(${REPO_OPTION_PREFIX})
...
macro(opendaq_setup_repo_compiler_flags REPO_OPTION_PREFIX)
    if (CMAKE_COMPILER_IS_GNUCXX)
        opendaq_setup_repo_gnu_compiler_flags(${REPO_OPTION_PREFIX})
    endif()

    if (MSVC)
        opendaq_setup_repo_msvc_compiler_flags(${REPO_OPTION_PREFIX})
    endif()

    if (CMAKE_COMPILER_IS_CLANGXX)
        opendaq_setup_repo_clang_compiler_flags(${REPO_OPTION_PREFIX})
    endif()
endmacro()

macro(opendaq_setup_repo_common_options REPO_OPTION_PREFIX)
    # Options
...
macro(opendaq_setup_repo REPO_OPTION_PREFIX)
    ...
    opendaq_setup_repo_common_options(${REPO_OPTION_PREFIX})

    set(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${CMAKE_BINARY_DIR}/bin)
    set(CMAKE_LIBRARY_OUTPUT_DIRECTORY ${CMAKE_BINARY_DIR}/bin)
    set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY ${CMAKE_BINARY_DIR}/bin)

    opendaq_setup_repo_compiler_flags(${REPO_OPTION_PREFIX})
    ...
    if ((CMAKE_COMPILER_IS_GNUCXX OR CMAKE_COMPILER_IS_CLANGXX) AND NOT MSVC)
        if (${REPO_OPTION_PREFIX}_FORCE_LLD_LINKER AND CMAKE_COMPILER_IS_GNUCXX)
