macro(setup_repo_version VAR_PREFIX REPO_NAME VERSION_FILE)
...
endmacro(setup_repo_version)

macro(setup_build_mode REPO_OPTION_PREFIX REPO_NAME)
...
macro(suppress_ext_lib_warnings)
    if (MSVC AND NOT CMAKE_COMPILER_IS_CLANGXX)
        # As above CMAKE_CXX_STANDARD but for VS
        add_compile_options($<$<COMPILE_LANGUAGE:CXX>:/std:c++17>)
...
endmacro(suppress_ext_lib_warnings)
